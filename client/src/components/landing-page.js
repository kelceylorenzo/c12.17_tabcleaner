...
class LandingPage extends Component {
	...
	render() {
		...
		let introSelect =
			this.state.view === 'introduction' ? 'home-showcase-selected' : 'home-showcase-notselected';
		let extensionSelect =
			this.state.view === 'extension' ? 'home-showcase-selected' : 'home-showcase-notselected';
		let startSelect =
			this.state.view === 'get-started' ? 'home-showcase-selected' : 'home-showcase-notselected';
		return (
